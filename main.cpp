...
QStringList islamicQuotes = {
    ...
    "\"আর তোমরা ব্যভিচারের কাছেও যেয়ো না। নিশ্চয়ই এটা অশ্লীল কাজ এবং মন্দ পথ।\" - (সূরা আল-ইসরা: ৩২)",
    "\"প্রতিটি ধর্মের একটি নিজস্ব স্বভাব রয়েছে, আর ইসলামের স্বভাব হলো লজ্জাশীলতা।\" - (ইবনে মাজাহ)",
    "\"আল্লাহ সবকিছু দেখছেন। নিজের চোখ ও মনকে পবিত্র রাখো।\"",
    "\"যে ব্যক্তি তার দুই চোয়ালের মধ্যবর্তী স্থান (জিহ্বা) এবং দুই পায়ের মধ্যবর্তী স্থানের জামানত আমাকে দেবে, আমি তার জান্নাতের জামানত দেব।\"",
    "\"চোখের ব্যভিচার হলো (হারাম কিছুর দিকে) তাকানো।\" - (সহীহ মুসলিম)",
    "\"ঈমান ও লজ্জাশীলতা একে অপরের সাথে যুক্ত। একটি উঠে গেলে অপরটিও উঠে যায়।\""
};
...
QStringList timeQuotes = {
    ...
    "\"বড় কিছু অর্জন করতে হলে ছোট ছোট বিভ্রান্তিগুলোকে 'না' বলতে শিখতে হবে।\"",
    "\"সময় ও স্রোত কারও জন্য অপেক্ষা করে না। তোমার লক্ষ্যকে প্রাধান্য দাও।\"",
    "\"সাফল্যের মূল রহস্য হলো মনোযোগ ধরে রাখা। বিক্ষিপ্ত মন নিয়ে বড় কিছু জয় করা যায় বোমা যায় না।\""
};
...
public:
    ...
    FocusApp() {
        ...
        // --- MODERN HTML/CSS LIKE STYLESHEET ---
        setStyleSheet(R"(
            QMainWindow { 
        ...
        passEdit->setFixedWidth(160);
        passEdit->setPlaceholderText("Enter unlock pass");
        topLayout->addWidget(passEdit);

        topLayout->addSpacing(30);
        topLayout->addWidget(new QLabel("Time (H:M):"));
        hrSpin = new QSpinBox(); hrSpin->setRange(0, 24); hrSpin->setFixedWidth(70);
        topLayout->addWidget(hrSpin);
        topLayout->addWidget(new QLabel(":"));
        minSpin = new QSpinBox(); minSpin->setRange(0, 59); minSpin->setFixedWidth(70);
        ...
        lblTimeLeft->setStyleSheet("color: #DC3545; font-size: 20px; font-weight: bold;");
        ...
        inputBlockApp = new QLineEdit(); 
        inputBlockApp->setPlaceholderText("e.g. game.exe");
        h1->addWidget(inputBlockApp);
        ...
        inputAllowApp = new QLineEdit(); 
        inputAllowApp->setPlaceholderText("e.g. word.exe");
        h3->addWidget(inputAllowApp);
